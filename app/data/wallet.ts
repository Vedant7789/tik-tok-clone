...
> = {
  crossmint: {
    ...
    gradient_bg: "linear-gradient(90deg, #995CFF 0%, #61B3FF 100%)",
  },
  wallet_connect: {
    title: "WalletConnect",
    image:
  ...
  eternl: {
    ...
    gradient_bg: "linear-gradient(90deg, #61B3FF 0%, #995CFF 100%)",
  },
  gerowallet: {
    title: "GeroWallet",
    image:
  ...
  metamask: {
    title: "Metamask",
    image:
      "https://server.nucast.io/storage/v1/object/public/web-assets/metamask.png?t=2023-06-29T08%3A53%3A38.261Z",
    gradient_bg:
