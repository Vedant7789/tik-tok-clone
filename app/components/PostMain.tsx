                ...
                <div id={`PostMain-${post.id}`} onClick={handleMobileVideoClick} className="flex border-b h-[100vh] md:h-full w-[100vw]">
                    ...
                    {showIcon && (
                        <div className="absolute z-10 w-full h-full flex items-center justify-center">
                            {isPlaying ? <FaPause className="text-white text-3xl" /> : <FaPlay className="text-white text-3xl" />}
                        </div>
                    )}
                        ...
                        <div className="flex items-center justify-between pb-0.5">
                            <div className="flex items-center gap-2">
                                <div className="cursor-pointer">
                                    <img className="rounded-full max-h-[30px]" width="30" src={useCreateBucketUrl(post?.profile?.image)} />
                                </div>
                ...
                <div id={`PostMain-${post.id}`} className="flex border-b py-6">
                    <div className="pl-3 w-full px-4 font-neue-regular">
                        ...
                        <div className="flex items-center justify-between pb-0.5">
                            <div className="flex items-center gap-2">
                                <div className="cursor-pointer">
                                    <img className="rounded-full max-h-[40px]" width="40" src={useCreateBucketUrl(post?.profile?.image)} />
                                </div>
                                <Link href={`/profile/${post.profile.user_id}`}>
