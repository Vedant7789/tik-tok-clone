...
export default function EditProfileOverlay() {
    ...
    useKeyPress(!uploadedImage ? updateUserInfo : cropAndUpdateImage, "Enter")
                                    ...
                                    <div className="flex items-center justify-center sm:-mt-6">
                                        <div className="sm:w-[60%] w-full max-w-md font-neue-regular tracking-wide">
                                            <textarea
                                                ...
                                                value={userBio || ""}
                                                maxLength={80}
                                                className="resize-none w-full bg-black/30 text-gray-300 border border-gray-300/30 rounded-md py-2.5 px-3 focus:outline-none"
                                            />
